...
export default function NotFound() {
  return (
    <div className="relative flex h-screen w-full items-center justify-center overflow-hidden bg-gradient-to-br from-gray-900 via-black to-gray-950 text-white">
      ...
      >
        <h1 className="text-[8rem] font-extrabold leading-none tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-600 drop-shadow-lg">
          404
        </h1>

        <p className="mt-4 text-xl md:text-2xl text-gray-300 max-w-lg">
      ...
      <motion.div
        ...
        className="absolute w-[600px] h-[600px] rounded-full border border-cyan-500/20 blur-2xl"
      />
    </div>
  )
}
